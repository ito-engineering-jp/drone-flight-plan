...
## ステータスボード（STATUS.md）の運用

- このプロジェクトで作業を始めるときは、まず必ず STATUS.md を読み、現在の進行状況（進行中・待ち・次・完了・保留）を把握してから作業を始めること。
- 作業の状態が変わったときは、STATUS.md の該当項目のラベルを書き換え、ファイル冒頭の「最終更新」の日付も更新すること。
- 新しく決まった作業や、待ち状態が発生したときは、STATUS.md の適切なセクションに項目を追加すること。
- ラベルの定義:
  - [進行中] いま手をつけている作業
  - [待ち]   他の作業・他人・外部の返信を待っている状態（待っている対象を必ず明記）
  - [次]     次にやる予定の作業
  - [完了]   完了した作業
  - [保留]   一旦止めている作業
